...
int main() {
    ...
    root = create_quadtree(load_image("images/building1.ppm"), 25);
    ...
    hide_message("0000000000111111111122222222223333333333", "images/building1.ppm", "tests/output/hide_message1.ppm");
